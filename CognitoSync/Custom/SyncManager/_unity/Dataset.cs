        ...
        private void RunSyncOperationAsync(int retry, Action<RunSyncOperationResponse> callback)
        {
            ...
            if (lastSyncCount == -1)
            {
                _remote.DeleteDatasetAsync(_datasetName, (cognitoResult) =>
                {
                    ...
                    {
                        var e = cognitoResult.Exception as DataStorageException;
            ...
            _remote.ListUpdatesAsync(_datasetName, lastSyncCount, (cognitoResult) =>
            {
                ...
                {
                    var e = listUpdatesException as DataStorageException;
                ...
                if (localChanges.Count != 0)
                {
                    ...
                    _remote.PutRecordsAsync(_datasetName, localChanges, datasetUpdates.SyncSessionToken, (putRecordsResult) =>
                    {
                        ...
                        if (putRecordsException != null)
                        {
                            ...
                            else if (putRecordsException.GetType() == typeof(DataStorageException))
                            {
